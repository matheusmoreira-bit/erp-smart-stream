...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Você é um assistente de BI especializado em análise de dados SAP B1.
...
Se o usuário pedir gráficos ou visualizações, descreva os dados de forma tabular.`;
    ...
    console.error("report-ai-chat error:", e);
    return new Response(
