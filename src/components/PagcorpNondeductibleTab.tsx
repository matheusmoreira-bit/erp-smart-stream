...
import { Plus, Trash2, Pencil, ShieldOff, Loader2 } from "lucide-react";
...
export function PagcorpNondeductibleTab() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-4">
        ...
        <Button onClick={() => { setEditing(null); setOpen(true); }} className="gap-2" disabled={!session?.companyDB}>
                  ...
                  {items.map((c) => (
                    <TableRow key={c.id}>
                      ...
                      <TableCell className="text-right">
                        ...
                        <Button variant="ghost" size="icon" aria-label="Remover" onClick={() => handleDelete(c)}>
