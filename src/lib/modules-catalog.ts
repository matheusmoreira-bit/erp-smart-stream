...
export const modules: Record<string, ModuleCard> = {
  analytics: {
    title: "Analytics",
...
export const moduleGroups: { title: string; keys: string[]; color: string; bgGlow: string }[] = [
  {
    title: "Aprovações",
    color: "text-violet-400",
    bgGlow: "from-violet-500/20 to-violet-500/5",
...
export function moduleHasAccess(mod: ModuleCard, userModules: string[]): boolean {
